...
public class Tela {
	...
	public static void menuMarca() {
		...
		do {
			...
			opcaoMarca = Validator.catchNumero("Digite a opção desejada: ", "Erro. Favor digitar um numero de 1 a 5");
			if (opcaoMarca != 5) {
	...
	public static void opcaoMarca(Integer opcaoMarca) {
		...
		case 1: {
			...
			if (!marca.existe(novaMarca)) {
				if (Validator.nome(novaMarca, "Erro. Favor digitar uma marca com até 30 caracteres")) {
					marca.cadastrar(novaMarca);
					System.out.println("Marca " + novaMarca + " cadastrada com sucesso.");
				}
			} else {
				System.out.println("A marca " + novaMarca + " já está cadastrada");
			}
			break;
		}
	...
	public static void opcaoProduto(Integer x) {
		...
		case 1: {
			...
			Double valor = Validator.catchPreco("Digite o valor do produto: ",
					"Erro ao digitar o valor do produto. Tente novamente");
			int quantidade = Validator.catchNumero("Digite a quantidade em estoque: ",
					"Favor digitar um numero inteiro");
			String marca = JOptionPane.showInputDialog("Digite a marca do produto: ");
			if (Validator.nome(nome, "Favor digitar um nome correto, sem espaços e com menos de 30 caracteres")
					&& Validator.nome(marca, "Favor digitar um nome correto, sem espaços e com menos de 30 caracteres")
		...
		case 4: {
			...
			Double valor = Validator.catchPreco("Digite o valor do produto: ",
					"Erro ao digitar o valor do produto. Tente novamente");
			Integer quantidade = Validator.catchNumero("Digite a quantidade em estoque: ",
					"Favor digitar um numero inteiro");
			String marca = JOptionPane.showInputDialog("Digite a marca do produto: ");
			if (quantidade >= 0
					&& Validator.nome(nome, "Favor digitar um nome correto, sem espaços e com menos de 30 caracteres")
					&& Validator.nome(marca,
							"Favor digitar uma marca correta, sem espaços e com menos de 30 caracteres")
					&& valor >= 0) {
		...
		case 5: {
			...
			System.out.println(produto.listar());
			Integer codExcluir = Validator.catchNumero("Qual código do produto que você deseja excluir?",
					"Favor digitar um numero inteiro");
