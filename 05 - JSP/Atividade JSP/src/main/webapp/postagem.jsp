...
<body>
	...
	<form action="cadastroPostagem.jsp" method="post" onsubmit="return valida()" id="cadastroComentario">
		<input type="text" placeholder="Nome" name="nomeComentario" id="nomeComentario" class="form-control">
		<input type="text" placeholder="Texto" name="postComentario" id="postComentario" class="form-control">
		<input type="hidden" name="codigoC" value="<% out.print(rs.getInt(1)); %>">
